  ...
  searchItems: [
    {
      ...
      children: [
        ...
        {
          url: { name: 'base-ui-dashboards-crm' },
    ...
    },
    {
      ...
      children: [
        ...
        {
          url: { name: 'base-ui-apps-user-view-id', params: { id: 21 } },
          icon: 'tabler-eye',
          title: 'User View',
        },
        {
        ...
        {
          url: { name: 'base-ui-pages-account-settings-tab', params: { tab: 'account' } },
          icon: 'tabler-user-circle',
          title: 'Account Settings - Account',
        },
        {
          url: { name: 'base-ui-pages-account-settings-tab', params: { tab: 'security' } },
          icon: 'tabler-lock-open',
          title: 'Account Settings - Security',
        },
        {
          url: { name: 'base-ui-pages-account-settings-tab', params: { tab: 'billing-plans' } },
          icon: 'tabler-currency-dollar',
          title: 'Account Settings - Billing',
        },
        {
          url: { name: 'base-ui-pages-account-settings-tab', params: { tab: 'notification' } },
          icon: 'tabler-bell',
          title: 'Account Settings - Notifications',
        },
        {
          url: { name: 'base-ui-pages-account-settings-tab', params: { tab: 'connection' } },
          icon: 'tabler-link',
