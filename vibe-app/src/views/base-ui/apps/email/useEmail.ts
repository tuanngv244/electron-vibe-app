...
export const useEmail = () => {
  const route = useRoute('base-ui-apps-email-filter')
  ...
  const emailMoveToFolderActions: { title: string; action: MoveEmailToAction; icon: string }[] = [
    { title:'Inbox', action: 'inbox', icon: 'tabler-mail' },
    { title:'Spam', action: 'spam', icon: 'tabler-alert-octagon' },
    { title:'Trash', action: 'trash', icon: 'tabler-trash' },
  ]
