...
const userData = useAppStorage<any>("userData");

const logout = async () => {
  // Remove "accessToken" from storage
  useAppStorage("accessToken").value = null;
  ...
  // Remove "userAbilities" from storage
  useAppStorage("userAbilityRules").value = null;
...
const userProfileList = [
  { type: "divider", badgeProps: {} },
  {
    type: "navItem",
    icon: "tabler-user",
    title: "Profile",
    to: { name: "base-ui-apps-user-view-id", params: { id: 21 } },
  },
  {
    type: "navItem",
  ...
  // { type: 'navItem', icon: 'tabler-file-dollar', title: 'Billing Plan', to: { name: 'base-ui-pages-account-settings-tab', params: { tab: 'billing-plans' } }, badgeProps: { color: 'error', content: '4' } },
  // { type: 'divider' },
