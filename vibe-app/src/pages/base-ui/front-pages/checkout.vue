...
import AddressContent from '@/views/base-ui/wizard-examples/checkout/Address.vue'
import CartContent from '@/views/base-ui/wizard-examples/checkout/Cart.vue'
import ConfirmationContent from '@/views/base-ui/wizard-examples/checkout/Confirmation.vue'
import PaymentContent from '@/views/base-ui/wizard-examples/checkout/Payment.vue'
import type { CheckoutData } from '@/views/base-ui/wizard-examples/checkout/types'
