...
import { basic, cellSlot, dense, expandableRows, externalPagination, fixedHeader, groupingRows, kitchenSink, rowEditingViaDialog, rowSelection } from '@/views/base-ui/demos/forms/tables/data-table/demoCodeDataTable'
</script>
