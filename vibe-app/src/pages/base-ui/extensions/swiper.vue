...
import { autoplay, basic, centeredSlidesOption1, centeredSlidesOption2, coverflowEffect, cubeEffect, fade, gallery, grid, lazyLoading, multipleSlidesPerView, navigation, pagination, progress, responsiveBreakpoints, virtualSlides } from '@/views/base-ui/demos/components/swiper/demoCodeSwiper'
</script>
