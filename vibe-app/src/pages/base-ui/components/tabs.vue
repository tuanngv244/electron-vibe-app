...
import { alignment, basic, basicPill, customIcons, dynamic, fixed, grow, pagination, programmaticNavigation, stacked, vertical, verticalPill } from '@/views/base-ui/demos/components/tabs/demoCodeTabs'
</script>
