...
import { block, colors, flat, group, icon, iconOnly, link, loaders, outlined, plain, rounded, router, sizing, text, tonal } from '@/views/base-ui/demos/components/button/demoCodeButton'
</script>
