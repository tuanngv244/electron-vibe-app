...
import { avatarStatus, color, dynamicNotifications, icon, maximumValue, position, showOnHover, style, tabs, tonal } from '@/views/base-ui/demos/components/badge/demoCodeBadge'
</script>
