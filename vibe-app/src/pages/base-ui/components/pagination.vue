...
import { basic, circle, color, disabled, icons, length, outline, outlineCircle, size, totalVisible } from '@/views/base-ui/demos/components/pagination/demoCodePagination'
</script>
