...
import { basic, border, closable, coloredBorder, colors, density, elevation, icons, outlined, prominent, tonal, type, vModelSupport } from '@/views/base-ui/demos/components/alert/demoCodeAlert'
</script>
