...
import { autoGrow, basic, browserAutocomplete, clearable, counter, icons, noResize, rows, states, validation, variant } from '@/views/base-ui/demos/forms/form-elements/textarea/demoCodeTextarea'
</script>
