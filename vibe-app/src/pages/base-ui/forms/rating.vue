...
import { basic, clearable, colors, density, hover, incremented, itemSlot, length, readonly, size } from '@/views/base-ui/demos/forms/form-elements/rating/demoCodeRating'
</script>
