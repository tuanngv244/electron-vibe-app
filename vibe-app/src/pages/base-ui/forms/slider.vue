...
import { appendAndPrepend, appendTextField, basic, colors, disabledAndReadonly, icons, minAndMax, size, step, thumb, ticks, validation, vertical } from '@/views/base-ui/demos/forms/form-elements/slider/demoCodeSlider'
</script>
