...
import { asyncItems, basic, chips, clearable, customFilter, density, multiple, slots, stateSelector, validation, variant } from '@/views/base-ui/demos/forms/form-elements/autocomplete/demoCodeAutocomplete'
</script>
