...
import { basic, chips, customTextAndValue, density, icons, menuProps, multiple, selectionSlot, variant } from '@/views/base-ui/demos/forms/form-elements/select/demoCodeSelect'
</script>
