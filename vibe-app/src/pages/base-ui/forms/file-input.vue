...
import { accept, basic, chips, counter, density, loading, multiple, prependIcon, selectionSlot, showSize, validation, variant } from '@/views/base-ui/demos/forms/form-elements/file-input/demoCodeFileInput'
</script>
