...
import { basic, dateAndTime, disabledRange, humanFriendly, inline, multipleDates, range, timePicker } from '@/views/base-ui/demos/forms/form-elements/date-time-picker/demoCodeDateTimePicker'
</script>
