...
import DealDetails from '@/views/base-ui/wizard-examples/create-deal/DealDetails.vue'
import DealReviewComplete from '@/views/base-ui/wizard-examples/create-deal/DealReviewComplete.vue'
import CreateDealType from '@/views/base-ui/wizard-examples/create-deal/DealType.vue'
import DealUsage from '@/views/base-ui/wizard-examples/create-deal/DealUsage.vue'

import type { CreateDealData } from '@/views/base-ui/wizard-examples/create-deal/types'
