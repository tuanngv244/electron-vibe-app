...
import PersonalDetails from '@/views/base-ui/wizard-examples/property-listing/PersonalDetails.vue'
import PriceDetails from '@/views/base-ui/wizard-examples/property-listing/PriceDetails.vue'
import PropertyArea from '@/views/base-ui/wizard-examples/property-listing/PropertyArea.vue'
import PropertyDetails from '@/views/base-ui/wizard-examples/property-listing/PropertyDetails.vue'
import PropertyFeatures from '@/views/base-ui/wizard-examples/property-listing/PropertyFeatures.vue'

import type { PropertyListingData } from '@/views/base-ui/wizard-examples/property-listing/types'
