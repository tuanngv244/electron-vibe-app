...
import InvoiceAddPaymentDrawer from '@/views/base-ui/apps/invoice/InvoiceAddPaymentDrawer.vue'
import InvoiceEditable from '@/views/base-ui/apps/invoice/InvoiceEditable.vue'
import InvoiceSendInvoiceDrawer from '@/views/base-ui/apps/invoice/InvoiceSendInvoiceDrawer.vue'

// Type: Invoice data
import type { InvoiceData, PurchasedProduct } from '@/views/base-ui/apps/invoice/types'
