...
import AcademyAssignmentProgress from '@/views/base-ui/apps/academy/AcademyAssignmentProgress.vue'
import AcademyCardPopularInstructors from '@/views/base-ui/apps/academy/AcademyCardPopularInstructors.vue'
import AcademyCardTopCourses from '@/views/base-ui/apps/academy/AcademyCardTopCourses.vue'
import AcademyCourseTable from '@/views/base-ui/apps/academy/AcademyCourseTable.vue'
import AcademyTopicYouAreInterested from '@/views/base-ui/apps/academy/AcademyTopicYouAreInterested.vue'
import AcademyUpcomingWebinar from '@/views/base-ui/apps/academy/AcademyUpcomingWebinar.vue'
