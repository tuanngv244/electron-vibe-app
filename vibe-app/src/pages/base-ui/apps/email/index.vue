...
import ComposeDialog from '@/views/base-ui/apps/email/ComposeDialog.vue'
import EmailLeftSidebarContent from '@/views/base-ui/apps/email/EmailLeftSidebarContent.vue'
import EmailView from '@/views/base-ui/apps/email/EmailView.vue'
import type { MoveEmailToAction } from '@/views/base-ui/apps/email/useEmail'
import { useEmail } from '@/views/base-ui/apps/email/useEmail'
...
// Composables
const route = useRoute<'base-ui-apps-email-filter' | 'base-ui-apps-email-label'>()
